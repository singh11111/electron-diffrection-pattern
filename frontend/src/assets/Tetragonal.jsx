...
function Tetragonal() {
  ...
  <span role="status"><h1>Welcome to Tetragonal system</h1> </span>
          ...
          <p><strong>    Center of Tetragonal system is considered as (0,0,0)</strong></p>
