...
function Monoclinic() {
  ...
  <span role="status"><h1>Welcome to Monoclinic system</h1> </span>
          ...
          <p><strong>    Center of Monoclinic system is considered as (0,0,0)</strong></p>
