...
function Orthorhombic() {
  return (
    <div className='orthorhombic'>
  
      <form className="p-1 p-md-3 border rounded-3 bg-body-tertiary">
      <button className="btn btn-primary" type="button" disabled>
  <span className="spinner-grow spinner-grow-sm" aria-hidden="true"></span>
  <span role="status"><h1>Welcome to Orthorhombic system</h1> </span>
</button>
          ...
          <p><strong>    Center of Orthorhombic system is considered as (0,0,0)</strong></p>
