...
function Trigonal() {
  ...
  <span role="status"><h1>Welcome to Trigonal system</h1> </span>
          ...
          <p><strong>    Center of Trigonal system is considered as (0,0,0)</strong></p>
